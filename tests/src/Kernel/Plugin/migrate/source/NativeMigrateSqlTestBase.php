...
use Drupal\Tests\workbench_moderation_migrate\Traits\MigrationTestDatabaseTrait;
 ...
 */
abstract class NativeMigrateSqlTestBase extends MigrateSqlSourceTestBase {

  use MigrationTestDatabaseTrait;
